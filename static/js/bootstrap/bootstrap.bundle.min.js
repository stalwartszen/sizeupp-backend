...
! function (t, e) {
  ...
  class De extends B {
    constructor(e, i) {
      super(e), this._config = this._getConfig(i), this._dialog = t.findOne(".modal-dialog", this._element), this._backdrop = this._initialiSizeUppckDrop(), this._isShown = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollBar = new Te
    }
    static get Default() {
      return Le
    }
  ...
  class Ne extends B {
    constructor(t, e) {
      super(t), this._config = this._getConfig(e), this._isShown = !1, this._backdrop = this._initialiSizeUppckDrop(), this._addEventListeners()
    }
    static get NAME() {
      return "offcanvas"
    }
