/*-----------------------------------------------------------------------------------
 ...
 Template URI: themes.himani'cc.com.com/Fastkart
 Description: This is Ecommerce website
 Author: himani'cc.com
 Author URI: https://themeforest.net/user/himani'cc.com
...
$(".close-button, .bg-overlay, .user-nav-pills .nav-item .nav-link").click(function() {
    $(".dashboard-left-sidebar").removeClass("show");
});
